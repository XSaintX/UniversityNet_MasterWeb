...
{
    public class MasterNetDbContext:IdentityDbContext<AppUser>//DbContext
    {
        ...
        //{
        //    optionsBuilder.UseSqlServer("Server=DESKTOP-5NIEU4B\\SQLEXPRESS;Database=LocalDatabase;Integrated Security=true; Trusted_Connection=True;TrustServerCertificate=True;")
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Curso>()
                ...
                .WithOne(m => m.Curso)
                .HasForeignKey(m => m.CursoId)
                .OnDelete(DeleteBehavior.Restrict);//si borras el curso se vuelve nulo
            ...
            modelBuilder.Entity<Curso>()
                ...
                j => { j.HasKey(t => new { t.PrecioId, t.CursoId }); }
                );
